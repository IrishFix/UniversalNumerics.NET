...
namespace ComputationalGeometry.Runtime {
    internal static class Intersection {
        ...
        [Pure] internal static Vector2 GetLineIntersection(Vector2 Line1P1, Vector2 Line1P2, Vector2 Line2P1, Vector2 Line2P2) {
        ...
        [Pure] internal static float GetAngleBetween(Vector2 Line1P1, Vector2 Line1P2, Vector2 Line2P1, Vector2 Line2P2) {
            float Slope1 = Slope(Line1P1, Line1P2);
            float Slope2 = Slope(Line2P1, Line2P2);
            return Angle(Slope1, Slope2);
        }

        [Pure] internal static bool AreSegmentsIntersecting(Vector2 Line1P1, Vector2 Line1P2, Vector2 Line2P1, Vector2 Line2P2) {
